...
public class ARTMultiObjectTrackingBasedOnColor : MonoBehaviour {
    ...
    /// </summary>
    ARTScripts.ARTWebcamTextureToMatHelper ARTwebCamTextureToMatHelper;

    // Use this for initialization
    void Start()
    {
        ARTwebCamTextureToMatHelper = gameObject.GetComponent<ARTScripts.ARTWebcamTextureToMatHelper>();
